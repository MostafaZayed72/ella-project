    ...
    <v-app-bar color="#02218f" height="fit-content" class="pt-3" absolute>
      ...
      <v-container fluid>
        ...
        C482,254.358,413.255,312.939,309.193,401.614z"
                ...
                <span style="color: #ffb457" class="mt-1">Wish Lists</span>
              </div>
              <div class="wishLists d-flex flex-column align-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span style="color: #ffb457" class="mt-1">Sign In</span>
              </div>
              <div
              ...
              >
                ...
                <span style="color: #ffb457" class="mt-1">Cart</span>
              </div>
            </div>
          </v-col>
        </v-row>
